/**
 * The `tooltip` page's entry point.
 *
 ...
 *
 * `TooltipApp` carries the whole IPC contract in its own header. Nothing else
...
if (!container) {
  throw new Error("the tooltip page has no #root element");
}
...
document.title = WINDOW_TITLES.tooltip;
