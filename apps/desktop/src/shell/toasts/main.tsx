 ...
 *
 * `ToastsApp` carries the whole IPC contract in its own header. Nothing else
 * is loaded here — no provider, no model, no snapshot.
 */
...
import "./toastsPage.css";

const container = document.getElementById("root");
if (!container) {
  throw new Error("the toasts page has no #root element");
}
...
document.title = WINDOW_TITLES.toasts;
