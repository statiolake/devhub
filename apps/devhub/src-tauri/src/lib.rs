...
use devhub_app_core::{
    ...
    OpaqueProviderMapping, OperationId, OperationToken, PortError, PortErrorCode, ProviderEvent,
    ProviderEventEnvelope, ProviderEventId, ReplayWire, ResourceInspection, RuntimeHealth,
...
impl NativeBridgeSink {
    ...
    #[cfg(test)]
    fn editor_surface_connected(&self, key: &editor::EditorSurfaceKey) -> bool {
        self.observations.lock().ok().is_some_and(|observations| {
...
struct NativeAppState {
    ...
    /// Typed startup barrier, distinguishing a reconstruction
...
impl NativeAppState {
    ...
    fn record_performance_probe(&self, marker: PerformanceMarker) {
        if self.performance_markers_enabled {
            ...
            // A run may use a short HOME whose secure diagnostics
    ...
    fn bootstrap_with_resource_dir(
        ...
        let performance_markers_enabled = std::env::var_os("DEVHUB_PERFORMANCE_MARKERS").is_some();
    ...
    fn reconstruct_window_inner(&self, app: &AppHandle) -> Result<(), AppErrorWire> {
        ...
        let window_identity = self
            .native_window_identity(&parent)
            .ok_or_else(|| AppErrorWire::native_unavailable())?;
    ...
    fn attach_startup_window(&self, app: &AppHandle) {
        ...
        match self.reconstruct_window_once(app) {
            Ok(()) => {
                ...
                // The explicit startup barrier is consumed by the worker
    ...
    fn execute_effects_until_with_options(
        ...
        while let Some(effect) = pending.pop_front() {
            ...
            let _had_error = first_error.is_some();
    ...
    fn reopen_from_dock(&self, app: &AppHandle) -> Result<(), AppErrorWire> {
        ...
        let result = (|| {
            ...
            let claimed_reconstruction = reopened || window_was_missing;
            let result = (|| {
...
/// Packaged builds use Tauri's resource directory; debug runs may point at
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            tauri::async_runtime::spawn(async move {
                ...
                // A degraded startup socket transition must not suppress
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::record_performance_marker,
            commands::start_workspace_picker,
            commands::cancel_workspace_picker,
            commands::select_workspace_picker,
            commands::choose_workspace_folder,
            commands::get_app_appearance,
            commands::ensure_editor_remote,
            commands::open_external_url,
            commands::get_agent_profiles,
            commands::dispatch_app_intent,
            commands::replay_app_events,
            commands::terminal_attach,
            commands::terminal_input,
            commands::terminal_resize,
            commands::terminal_acknowledge,
            commands::terminal_detach,
            commands::agent_surface_attach,
            commands::agent_surface_input,
            commands::agent_surface_resize,
            commands::agent_surface_acknowledge,
            commands::agent_surface_detach,
            commands::get_settings_snapshot,
            commands::save_settings,
            commands::reload_settings,
            commands::recheck_settings,
            commands::open_log_folder,
            commands::copy_diagnostics,
            commands::apply_socket_change,
